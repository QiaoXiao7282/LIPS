...
def parse_args():
    ...
    ## model
    parser.add_argument('--model', type=str, default='ResNet10', help='model name') ## vgg11_bn, ResNet8
...
exp_args = dict(
    ...
    other=dict(test_freq=1, logging_path=f'./logging/tiny_fedcac_resnet/{args.noniid}_{args.alpha}_{args.tau}_{args.beta}_{args.dst}_{args.density_init}_{args.seed}')
)
